...
void sendSensorData() {
  ...
  Serial.println(validFloat(t_dht) ? String(t_dht, 2) : "NaN");
  Serial.print(" | LM35_C: ");
  Serial.println(validFloat(t_lm35) ? String(t_lm35, 2) : "NaN");

  // ---- Serial output (CSV for Processing) ----
  // Header: timestamp_ms,ds18b20_c,dht11_c,lm35_c
  // Example line: 12345,24.50,24.00,24.70
  Serial.print(millis());
  Serial.print(",");
  Serial.print(validFloat(t_ds) ? String(t_ds, 2) : "NaN");
  Serial.print(",");
...
void setup() {
  ...
  Serial.println("# CSV_HEADER: timestamp_ms,ds18b20_c,dht11_c,lm35_c");
